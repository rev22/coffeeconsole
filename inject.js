...
(function() {
  (function(window, document) {
    ...
    if (iframe = document.getElementById("coffeeconsole")) {
      ...
      return document.getElementById("coffeeconsole").style.display = "block";
    } else {
      ...
      doc.close();
      return iframe.contentWindow.onload = function() {
        return this.document.getElementById("exec").focus();
      };
    }
  })(this, document);
