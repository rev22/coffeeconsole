...
(function(window) {
  ...
  ccFusor.stringify = function(o, simple, visited) {
    return (function(_this) {
      return function(_arg) {
        ...
        if (circular) {
          ...
          while (i < names.length) {
            try {
              parts.push(names[i] + ": " + ccFusor.stringify(o[names[i]], true, visited));
            } catch (_error) {
              e = _error;
  ...
  run = function(cmd) {
    ...
    if (internalCmd) {
      ...
      return [className, cleanse(ccFusor.stringify(rawoutput))];
    }
  };
  ...
  if (enableCC) {
    reportError((function(_this) {
      return function() {
        exec.parentNode.innerHTML = "<div autofocus id=\"exec\" class=\"exec\" autocapitalize=\"off\" spellcheck=\"false\"><span id=\"cursor\" class=\"cursor\" spellcheck=\"false\" autocapitalize=\"off\" autocorrect=\"off\"" + (iOSMobile ? "" : " contenteditable") + "></span></div>";
        exec = document.getElementById("exec");
