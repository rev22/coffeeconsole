...
(function(window) {
  var about, appendLog, baseURL, body, ccCache, ccPosition, ccfusor, changeView, checkTab, cleanse, codeComplete, codeCompleteTimer, commands, completeCode, cursor, dblTapTimer, e, echo, enableCC, exec, fakeConsole, fakeInput, fakeInputFocused, fileupload, findNode, form, getHistory, getProps, history, historySupported, iOSMobile, info, injected, internalCommand, keypressTimer, lastCmd, libraries, liveHistory, load, loadDOM, loadScript, log, logAfter, modifierkeys, noop, output, pos, post, remoteId, removeSuggestion, run, sandbox, sandboxframe, setCursorTo, setHistory, showHistory, showhelp, sortci, sse, stringify, taps, trim, version, whichKey, _ref;
  version = "0.0.3";
  ccfusor = {
